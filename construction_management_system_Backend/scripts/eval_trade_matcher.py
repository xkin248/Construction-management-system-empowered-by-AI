...
CASES = [
    ...
    # Bahasa Melayu (BM) — 2 cases per trade
    ("pasang kabinet dapur", "carpenter"),
    ("kerja tukang kayu bina bingkai", "carpenter"),
    ("pasang pendawaian elektrik", "electrical"),
    ("baiki lampu dan kabel", "electrical"),
    ("baiki paip bocor", "plumbing"),
    ("pasang pili air tandas", "plumbing"),
    ("bina dinding bata", "masonry"),
    ("tuang konkrit untuk tiang", "masonry"),
    ("mengecat dinding rumah", "painting"),
    ("sapu cat dinding", "painting"),
    ("kimpal besi keluli", "welding"),
    ("kerja pengimpal bingkai keluli", "welding"),
    ("pasang penghawa dingin", "hvac"),
    ("baiki penyaman udara", "hvac"),
    ("ganti atap bumbung", "roofing"),
    ("pasang bumbung baru", "roofing"),
    ("pasang jubin lantai", "tiling"),
    ("kerja jubin bilik air", "tiling"),
    ("pasang dinding kering", "drywall"),
    ("kerja papan gypsum siling", "drywall"),
    ("pasang kaca tingkap", "glazing"),
    ("ganti kaca tingkap pecah", "glazing"),
    ("pasang lantai vinil", "flooring"),
    ("kerja lantai lamina", "flooring"),
    ("kendalikan jengkaut", "equipment"),
    ("operasi kren untuk angkat", "equipment"),
    ("kerja buruh angkat barang", "laborer"),
    ("kerja perobohan bangunan", "laborer"),
    ("pasang penebat haba", "insulation"),
    ("kerja penebat dinding", "insulation"),
    ("penyelia tapak periksa", "supervision"),
    ("kerja pemeriksa keselamatan", "supervision"),
]
